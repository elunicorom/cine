...
<div class="w3-top">
  <div class="w3-bar w3-brown w3-card-2">
    ...
    <a href="{{ url('form_crear') }}" class="w3-bar-item w3-button w3-padding-large" >Crear</a>
    <a href="{{ url('listar') }}" class="w3-bar-item w3-button w3-padding-large w3-hide-small">Listar</a>
    </div>
